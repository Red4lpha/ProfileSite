...
export const MobileNav = () => {
  return (
    ...
    <a href='/' >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="-2 -2 24 24" width="32" fill="currentColor" aria-labelledby='githubTitle'>
        <title id='githubTitle'>Link to my Github account</title>
      ...
      <a href='/'>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="-2 -2 24 24" width="32" fill="currentColor" aria-labelledby='linkedinTitle'>
      <title id='githubTitle'>Link to my LinkedIn account</title>
      ...
      <a href='/'>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="-2 -2 24 24" width="32" fill="currentColor" aria-labelledby='twitterTitle'>
      <title id='twitterTitle'>Link to my Twitter account</title>
